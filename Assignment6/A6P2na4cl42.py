...
name="Na4Cl42"       # for output files
nNa = 4
nCl = 4
n = nNa + nCl
a = 0.2
sqrt2 = pow(2, 0.5)
r_Na = [  [ a/sqrt2, 0, 0 ], [ 0, a+a/sqrt2, 0], [a+a/sqrt2, a+a*sqrt2, 0], [a+a*sqrt2, a/sqrt2, 0] ]
r_Cl = [  [ 0, a/sqrt2, 0 ], [ a/sqrt2, a+a*sqrt2, 0 ], [a+a*sqrt2, a+a/sqrt2, 0], [a+a/sqrt2, 0, 0] ]
